...
<body>
  ...
  <nav>
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $query = "INSERT INTO about (image_path) VALUES ('$image_path')";
        if(mysqli_query($conn, $query)) {
            echo "<script> alert('Hotel Image Uploaded Successfully!'); </script>";
        } else {
            echo "Hotel Image Failed to Upload." . $conn->error;
        }
    }
    ?>
    ...
    <div class="myTable">
        <table border="1" cellspacing="0px">
            ...
            <?php
            $query = "SELECT * FROM about ORDER BY upload_date DESC";
            ...
            if ($result->num_rows > 0) {
                ...
                echo "<tr><td colspan='5'>No Hotel Image Available.</td></tr>";
            }
            ?>
        </table>
    </div>
